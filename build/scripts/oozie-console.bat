...
@rem ##########################################################################
@rem
@rem  oozie-console startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and OOZIE_CONSOLE_OPTS to pass JVM options to this script.
...
@rem Execute oozie-console
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %OOZIE_CONSOLE_OPTS%  -classpath "%CLASSPATH%" com.smelser.oozie.Application %CMD_LINE_ARGS%
...
:fail
rem Set variable OOZIE_CONSOLE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%OOZIE_CONSOLE_EXIT_CONSOLE%" exit 1
exit /b 1
